"""
Django settings for our timberwyck project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'timberwyck/apps'))
    ...
    ROOT_URLCONF = 'timberwyck.urls'

    WSGI_APPLICATION = 'timberwyck.wsgi.application'
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "timberwyck/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "timberwyck/static"),
    )
